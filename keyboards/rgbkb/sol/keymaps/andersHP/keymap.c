...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_LCTL, KC_LGUI, KC_LALT,     ADJ,  KC_SPC,  KC_DEL,  KC_ENT,  KC_SPC,      FN, KC_LEFT, KC_DOWN,   KC_UP, KC_RIGHT, \
  ...
  [_ADJ] =  LAYOUT( \
    ...
    RGB_TOG, _______, RGB_RMOD, RGB_MOD, _______, _______, _______, _______, _______,   KC_P0, KC_PDOT, KC_NLCK,  QWERTY, COLEMAK, \
                                                 _______, _______, _______, _______ \
  )
};
